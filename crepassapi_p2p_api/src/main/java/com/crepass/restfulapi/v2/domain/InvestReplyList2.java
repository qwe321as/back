...
public class InvestReplyList2 {
	...
	private String scoreLenddo; 	// 201221 렌도점수
	...
	private int replyCount;	// 대출진행률
	
	private String eduFlag;	// 크레파스교육 이수여부
	
	private String corpGrade;		// (대출)회사에서 매기는 등급
